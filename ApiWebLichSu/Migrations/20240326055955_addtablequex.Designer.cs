...
namespace ApiWebLichSu.Migrations
{
    ...
    [Migration("20240326055955_addtablequex")]
    partial class addtablequex
    {
            ...
            modelBuilder.Entity("ApiWebLichSu.Model.Quest", b =>
                {
                    ...
                    b.Property<int>("questCollectionid_questcollection")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("questCollectionid_questcollection");
            ...
            modelBuilder.Entity("ApiWebLichSu.Model.Quest", b =>
                {
                    ...
                    b.HasOne("ApiWebLichSu.Model.QuestCollection", "questCollection")
                        .WithMany()
                        .HasForeignKey("questCollectionid_questcollection")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
